// GFL - Sangvis Ferri (Occupant or Invader / OPFOR-style)

["name", "GFL - Sangvis Ferri"] call _fnc_saveToTemplate;
["spawnMarkerName", format [localize "STR_supportcorridor", "Sangvis Ferri"]] call _fnc_saveToTemplate;
...
["ammobox", "Box_AAF_AmmoOrd_F"] call _fnc_saveToTemplate;
["surrenderCrate", "Box_AAF_Wps_F"] call _fnc_saveToTemplate;
...
//       Vehicles       //
//////////////////////////
// Sangvis Ferri uses AAF-style vehicles to represent their
// captured/appropriated independent military hardware.

private _vehiclesBasic = ["A_MRAP_01_F"];
private _vehiclesLightUnarmed = ["A_MRAP_01_F"];
private _vehiclesLightArmed = ["A_MRAP_01_hmg_F"];
private _vehiclesTrucks = ["A_Truck_01_transport_F", "A_Truck_01_covered_F"];
private _vehiclesCargoTrucks = ["A_Truck_01_box_F"];
private _vehiclesLightAPCs = ["A_APC_Wheeled_03_cannon_F"];
private _vehiclesAPCs = ["A_APC_Wheeled_03_cannon_F"];
private _vehiclesIFVs = ["A_APC_Tracked_01_rcws_F"];
private _vehiclesTanks = ["A_MBT_01_cannon_F"];
private _vehiclesLightTanks = ["A_APC_Wheeled_03_cannon_F"];
private _vehiclesAA = ["A_APC_Tracked_01_AA_F"];
// SF uses OPFOR helicopters (appropriated) — AAF has no helicopter in vanilla
...
private _vehiclesMilitiaLightArmed = ["A_MRAP_01_hmg_F"];
private _vehiclesMilitiaTrucks = ["A_Truck_01_transport_F"];
private _vehiclesMilitiaCars = ["A_MRAP_01_F"];
private _vehiclesPolice = ["A_MRAP_01_F"];
...
["staticMGs", ["A_HMG_01_F", "A_HMG_01_high_F"]] call _fnc_saveToTemplate;
["staticAT", ["A_static_AT_F"]] call _fnc_saveToTemplate;
["staticAA", ["A_static_AA_F"]] call _fnc_saveToTemplate;
["staticMortars", ["A_Mortar_01_F"]] call _fnc_saveToTemplate;
...
["faces", [
    "sangvisguardface", "sangvisjaegerface",
    "sangvisripperface", "sangvisvespidface"
...
private _uniforms = [
    "sangvisguard_uniform", "sangvisjaeger_uniform",
    "sangvisripper_uniform", "sangvisvespid_uniform"
];

private _vests = ["V_PlateCarrier1_blk", "V_TacVestIR_blk", "V_BandollierB_rgr"];
private _hvests = ["V_PlateCarrierSpec_blk", "V_PlateCarrierGL_rgr"];
private _helmets = ["H_HelmetB", "H_HelmetB_light"];
private _slHat = ["H_HelmetSpecB"];
private _sniHats = ["H_HelmetSpecB"];
private _backpacks = ["B_AssaultPack_mcamo", "B_FieldPack_ocamo", "B_Carryall_mcamo"];
private _atBackpacks = ["B_Carryall_mcamo"];
private _longRangeRadios = ["B_RadioBag_01_mtp_F"];

// ----- Weapons -----
// SF uses NATO-style weapons (captured/stolen from GnK and other factions).
// ----- Weapons -----
private _rifles = [
...
private _slRifles = [
    ["arifle_MXM_F", "", "acc_flashlight", "optic_SOS_zoomonly",
        ["20Rnd_65x39_caseless_mag", "20Rnd_65x39_caseless_mag"], [], ""]
];
private _carbines = [
...
private _smgs = [
    ["SMG_01_F", "", "acc_flashlight", "optic_Holosight_smg",
        ["30Rnd_45ACP_Mag_F", "30Rnd_45ACP_Mag_F"], [], ""]
];
private _mgs = [
    ["LMG_Mk200_F", "", "", "optic_Hamr",
        ["200Rnd_65x39_cased_Box", "200Rnd_65x39_cased_Box", "200Rnd_65x39_cased_Box_Tracer"], [], ""]
];
private _marksmanRifles = [
    ["srifle_DMR_03_F", "", "", "optic_SOS_zoomonly",
...
private _atLaunchers = [
    ["launch_RPG32_F", "", "", "", ["RPG32_F", "RPG32_F"], [], ""]
];
private _missileATLaunchers = [
    ["launch_RPG32_F", "", "", "", ["RPG32_F", "RPG32_F", "RPG32_F"], [], ""]
];
private _aaLaunchers = [
    ["launch_Strela_F", "", "", "", ["R_Strela_AA", "R_Strela_AA"], [], ""]
];
private _sidearms = [
...
_crewLoadoutData set ["uniforms", ["U_B_PilotCoveralls"]];
