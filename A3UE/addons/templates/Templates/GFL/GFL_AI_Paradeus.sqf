// GFL - Paradeus (Invader / OPFOR)
// Special creatures: GFL_Bellator137, GFL_Goliath_HE, GFL_Goliath_AT (vehicle-type, not infantry)

["name", "GFL - Paradeus"] call _fnc_saveToTemplate;
["spawnMarkerName", format [localize "STR_supportcorridor", "Paradeus"]] call _fnc_saveToTemplate;
...
//       Vehicles       //
//////////////////////////
// Paradeus uses OPFOR (CSAT-style) vehicles as their main transport.
...
private _vehiclesIFVs = ["O_APC_Tracked_02_AA_F"];
...
// Bellator/Goliath creatures are vehicle-type units, not uniformed infantry.
private _uniforms = [
...
// ----- Weapons -----
// ----- Weapons -----
// Paradeus in GFL uses advanced/heavy weaponry.
private _rifles = [
...
/////////////////////////////////
// Reusing standard unit templates — same logic as Elmo, different loadout sets.
