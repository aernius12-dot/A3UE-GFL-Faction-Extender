// GFL - Mangi Mercenaries (Occupant / AI faction)

["name", "GFL - Mangi Mercenaries"] call _fnc_saveToTemplate;
["spawnMarkerName", format [localize "STR_supportcorridor", "Mangi Mercenaries"]] call _fnc_saveToTemplate;
...
["ammobox", "Box_IND_AmmoOrd_F"] call _fnc_saveToTemplate;
...
//       Vehicles       //
//////////////////////////
// Mangi Mercenaries use INDFOR (independent) vehicles to
// reflect their non-state mercenary identity.
...
private _vehiclesTrucks = ["I_Truck_02_transport_F", "I_Truck_02_covered_F"];
private _vehiclesCargoTrucks = ["I_Truck_02_box_F"];
private _vehiclesLightAPCs = ["I_APC_Wheeled_03_cannon_F"];
private _vehiclesAPCs = ["I_APC_Wheeled_03_cannon_F"];
private _vehiclesIFVs = ["I_APC_Tracked_03_cannon_F"];
private _vehiclesTanks = ["I_MBT_03_cannon_F"];
private _vehiclesLightTanks = ["I_APC_Wheeled_03_cannon_F"];
private _vehiclesAA = ["I_APC_Tracked_03_AA_F"];
private _vehiclesHelisLight = ["I_Heli_light_03_unarmed_F"];
private _vehiclesHelisTransport = ["I_Heli_Transport_02_F"];
private _vehiclesHelisLightAttack = ["I_Heli_light_03_F"];
private _vehiclesHelisAttack = ["I_Heli_Attack_02_F"];
private _vehiclesPlanesCAS = ["I_Plane_Fighter_04_F"];
private _vehiclesPlanesAA = ["I_Plane_Fighter_04_F"];
private _vehiclesPlanesTransport = [];
private _vehiclesMilitiaLightArmed = ["I_MRAP_03_hmg_F"];
private _vehiclesMilitiaTrucks = ["I_Truck_02_transport_F"];
private _vehiclesMilitiaCars = ["I_MRAP_03_F"];
private _vehiclesPolice = ["I_MRAP_03_F"];
private _vehiclesAirPatrol = ["I_Heli_light_03_unarmed_F"];
...
["faces", [
    "blasterface", "mechanistface", "spotterface", "strikecaptainface"
]] call _fnc_saveToTemplate;

["voices", ["Male10ENG"]] call _fnc_saveToTemplate;
...
private _uniforms = [
    "blaster_uniform", "mechanist_uniform",
    "spotter_uniform", "strikecaptain_uniform"
];

private _vests = ["V_PlateCarrier1_rgr", "V_TacVestIR_blk", "V_BandollierB_khk"];
private _hvests = ["V_PlateCarrierSpec_mtp", "V_PlateCarrierIAGL_oli"];
private _helmets = ["H_HelmetB", "H_HelmetB_light"];
private _slHat = ["H_HelmetSpecB"];
private _sniHats = ["H_HelmetSpecB"];
private _backpacks = ["B_AssaultPack_rgr", "B_FieldPack_oli", "B_Carryall_oli"];
private _atBackpacks = ["B_Carryall_oli"];
private _longRangeRadios = ["B_RadioBag_01_mtp_F"];

// ----- Weapons -----
// Mercenaries use a mix of NATO and CSAT weapons — whatever pays.
// ----- Weapons -----
private _rifles = [
...
private _sidearms = [
    ...
    ["hgun_ACPC2_F", "", "acc_flashlight_pistol", "", ["9Rnd_45ACP_Mag", "9Rnd_45ACP_Mag"], [], ""]
];
...
_crewLoadoutData set ["uniforms", ["U_I_pilotCoveralls"]];
